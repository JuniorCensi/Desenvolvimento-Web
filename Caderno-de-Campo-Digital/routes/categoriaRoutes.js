...
const validarCategoria = [
    body('nome')
        ...
        .isLength({ max: 30 }).withMessage('Nome deve ter no máximo 30 caracteres.'),
    body('descricao')
        .optional().isLength({ max: 100 }).withMessage('Descrição deve ter no máximo 100 caracteres.'),
    body('cor')
        .notEmpty().withMessage('Cor é obrigatória.')
        .isIn(['E39AFF', 'FFD0A1', 'FF9092']).withMessage('Cor deve ser uma das opções válidas: E39AFF (uva), FFD0A1 (pêssego), FF9092 (ameixa).')
];
